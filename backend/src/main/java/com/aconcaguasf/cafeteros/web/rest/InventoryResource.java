...
/**
 * REST controller for managing {@link com.aconcaguasf.cafeteros.domain.Inventory}.
 */
@RestController
@RequestMapping("/api")
public class InventoryResource {
    ...
    public ResponseEntity<InventoryDTO> updateInventory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, inventoryDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<InventoryDTO> partialUpdateInventory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, inventoryDTO.getId().toString())
        );
    }
